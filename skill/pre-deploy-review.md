...
3. For every dangerous authority (PermanentDelegate, MintAuthority, Pausable, TransferHook, TransferFee, Close, Freeze): confirm it is either renounced before launch or intentional and disclosed.
...
- [ ] `MintAuthority` renounced (fixed supply) or minting policy disclosed
...
- [ ] No illegal or dangerous-legal combinations left unaddressed
